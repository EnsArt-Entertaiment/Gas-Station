...
Shader "EnsArt & Striped Halo"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_PrimaryColor("PrimaryColor", Color) = (0.3139462,0.7830189,0.4261438,1)
		_SecondaryColor1("SecondaryColor", Color) = (0.3139462,0.7830189,0.4261438,1)
		_Alpha("Alpha", Range( -2 , 2)) = 0
		_Gradient("Gradient", Range( 0 , 1)) = 0.404891
		[ASEEnd]_StripesValue("Stripes Value", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float cos10_g5 = cos( radians( 90.0 ) );
				float sin10_g5 = sin( radians( 90.0 ) );
				float2 rotator10_g5 = mul( IN.ase_texcoord8.xy - float2( 0.5,0.5 ) , float2x2( cos10_g5 , -sin10_g5 , sin10_g5 , cos10_g5 )) + float2( 0.5,0.5 );
				float2 appendResult8_g5 = (float2(15.0 , 1.0));
				float2 appendResult9_g5 = (float2(0.0 , 0.0));
				float2 appendResult10_g6 = (float2(0.5 , 1.0));
				float2 temp_output_11_0_g6 = ( abs( (frac( (rotator10_g5*appendResult8_g5 + appendResult9_g5) )*2.0 + -1.0) ) - appendResult10_g6 );
				float2 break16_g6 = ( 1.0 - ( temp_output_11_0_g6 / fwidth( temp_output_11_0_g6 ) ) );
				
				float cos10_g3 = cos( radians( 90.0 ) );
				float sin10_g3 = sin( radians( 90.0 ) );
				float2 rotator10_g3 = mul( IN.ase_texcoord8.xy - float2( 0.5,0.5 ) , float2x2( cos10_g3 , -sin10_g3 , sin10_g3 , cos10_g3 )) + float2( 0.5,0.5 );
				float2 appendResult8_g3 = (float2(15.0 , 1.0));
				float2 appendResult9_g3 = (float2(_StripesValue , 0.0));
				float2 appendResult10_g4 = (float2(0.5 , 1.0));
				float2 temp_output_11_0_g4 = ( abs( (frac( (rotator10_g3*appendResult8_g3 + appendResult9_g3) )*2.0 + -1.0) ) - appendResult10_g4 );
				float2 break16_g4 = ( 1.0 - ( temp_output_11_0_g4 / fwidth( temp_output_11_0_g4 ) ) );
				
				float clampResult33 = clamp( ( ( _Gradient - IN.ase_texcoord9.xyz.y ) / _Alpha ) , 0.0 , 1.0 );
				

				float3 BaseColor = ( _PrimaryColor * saturate( min( break16_g6.x , break16_g6.y ) ) ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( _SecondaryColor1 * saturate( min( break16_g4.x , break16_g4.y ) ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float clampResult33 = clamp( ( ( _Gradient - IN.ase_texcoord2.xyz.y ) / _Alpha ) , 0.0 , 1.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float cos10_g5 = cos( radians( 90.0 ) );
				float sin10_g5 = sin( radians( 90.0 ) );
				float2 rotator10_g5 = mul( IN.ase_texcoord4.xy - float2( 0.5,0.5 ) , float2x2( cos10_g5 , -sin10_g5 , sin10_g5 , cos10_g5 )) + float2( 0.5,0.5 );
				float2 appendResult8_g5 = (float2(15.0 , 1.0));
				float2 appendResult9_g5 = (float2(0.0 , 0.0));
				float2 appendResult10_g6 = (float2(0.5 , 1.0));
				float2 temp_output_11_0_g6 = ( abs( (frac( (rotator10_g5*appendResult8_g5 + appendResult9_g5) )*2.0 + -1.0) ) - appendResult10_g6 );
				...
				float cos10_g3 = cos( radians( 90.0 ) );
				float sin10_g3 = sin( radians( 90.0 ) );
				float2 rotator10_g3 = mul( IN.ase_texcoord4.xy - float2( 0.5,0.5 ) , float2x2( cos10_g3 , -sin10_g3 , sin10_g3 , cos10_g3 )) + float2( 0.5,0.5 );
				float2 appendResult8_g3 = (float2(15.0 , 1.0));
				float2 appendResult9_g3 = (float2(_StripesValue , 0.0));
				float2 appendResult10_g4 = (float2(0.5 , 1.0));
				float2 temp_output_11_0_g4 = ( abs( (frac( (rotator10_g3*appendResult8_g3 + appendResult9_g3) )*2.0 + -1.0) ) - appendResult10_g4 );
				...
				float clampResult33 = clamp( ( ( _Gradient - IN.ase_texcoord5.xyz.y ) / _Alpha ) , 0.0 , 1.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float cos10_g5 = cos( radians( 90.0 ) );
				float sin10_g5 = sin( radians( 90.0 ) );
				float2 rotator10_g5 = mul( IN.ase_texcoord2.xy - float2( 0.5,0.5 ) , float2x2( cos10_g5 , -sin10_g5 , sin10_g5 , cos10_g5 )) + float2( 0.5,0.5 );
				float2 appendResult8_g5 = (float2(15.0 , 1.0));
				float2 appendResult9_g5 = (float2(0.0 , 0.0));
				float2 appendResult10_g6 = (float2(0.5 , 1.0));
				float2 temp_output_11_0_g6 = ( abs( (frac( (rotator10_g5*appendResult8_g5 + appendResult9_g5) )*2.0 + -1.0) ) - appendResult10_g6 );
				...
				float clampResult33 = clamp( ( ( _Gradient - IN.ase_texcoord3.xyz.y ) / _Alpha ) , 0.0 , 1.0 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float clampResult33 = clamp( ( ( _Gradient - IN.ase_texcoord4.xyz.y ) / _Alpha ) , 0.0 , 1.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float clampResult33 = clamp( ( ( _Gradient - IN.ase_texcoord.xyz.y ) / _Alpha ) , 0.0 , 1.0 );
				

				surfaceDescription.Alpha = clampResult33;
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;19;-1310.037,-81.87319;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-1715.744,-147.9615;Inherit;False;Property;_Gradient;Gradient;3;0;Create;True;0;0;0;False;0;False;0.404891;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;16;-1683.369,-17.75109;Inherit;True;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleDivideOpNode;27;-894.9723,2.757555;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;473.5549,-20;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;EnsArt & Striped Halo;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;1;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;1;638162976962810941;  Refraction Model;0;0;  Blend;0;0;Two Sided;2;638179278136825025;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;638179278274774441;Transmission;0;638162982367798358;  Transmission Shadow;0.5,False,;0;Translucency;0;638162982250888034;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;0;638162977812296933;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1227.762,242.0291;Inherit;False;Property;_Alpha;Alpha;2;0;Create;True;0;0;0;False;0;False;0;0;-2;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;33;-574.3918,115.1046;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;42;-844.6639,-213.0419;Inherit;True;Stripes;-1;;3;8e73a71cdf24db740864b4c3f3357e7f;0;4;5;FLOAT;15;False;4;FLOAT;0;False;3;FLOAT;0.5;False;12;FLOAT;90;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;43;-511.1419,-338.0185;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;44;-1054.342,-437.319;Inherit;False;Property;_SecondaryColor1;SecondaryColor;1;0;Create;True;0;0;0;False;0;False;0.3139462,0.7830189,0.4261438,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;34;-656.8854,-676.8764;Inherit;True;Stripes;-1;;5;8e73a71cdf24db740864b4c3f3357e7f;0;4;5;FLOAT;15;False;4;FLOAT;0;False;3;FLOAT;0.5;False;12;FLOAT;90;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;39;-323.3628,-801.853;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;40;-866.5632,-901.1537;Inherit;False;Property;_PrimaryColor;PrimaryColor;0;0;Create;True;0;0;0;False;0;False;0.3139462,0.7830189,0.4261438,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;41;-1142.759,-207.4772;Inherit;False;Property;_StripesValue;Stripes Value;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
WireConnection;42;4;41;0
WireConnection;43;0;44;0
WireConnection;43;1;42;0
WireConnection;39;0;40;0
WireConnection;39;1;34;0
ASEEND*/
//CHKSM=442D7F69CAE57694743B0ADDAFFE234D9173B16A